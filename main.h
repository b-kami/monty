...
#include <sys/types.h>
/**
 * struct stack_s - doubly linked list representation of the stack (or queue)
 * @n: The int
...
/**
 * struct bus_s - varibls -args, file, line content
 * @arg: The value
 * @file: The pointer to monty file
 * @content: The line content
 * @lifi: The flag change stack <-> queue
 * Description: carries values through the progrm
 */
